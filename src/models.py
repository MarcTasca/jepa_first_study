...
class Encoder(nn.Module):
    ...
    """
    def __init__(self, input_dim=2, hidden_dim=256, embedding_dim=32):
        super().__init__()
...
class Predictor(nn.Module):
    ...
    """
    def __init__(self, embedding_dim=32, hidden_dim=256):
        super().__init__()
        self.net = nn.Sequential(
...
class Decoder(nn.Module):
    ...
    """
    def __init__(self, embedding_dim=32, output_dim=2, hidden_dim=256):
        super().__init__()
        self.net = nn.Sequential(
            nn.Linear(embedding_dim, hidden_dim),
            nn.LayerNorm(hidden_dim),
